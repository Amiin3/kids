...
function PublicStok({ products, brandName, totalStok }) {
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setTime((/* @__PURE__ */ new Date()).toLocaleTimeString("id-ID", { hour: "2-digit", minute: "2-digit", second: "2-digit" }) + " WIB");
    }, 1e3);
  ...
  const filteredAreas = areasData.filter(
    (item) => item.kota.toLowerCase().includes(searchQuery.toLowerCase()) || item.prov.toLowerCase().includes(searchQuery.toLowerCase())
  );
  return /* @__PURE__ */ jsxs("div", { className: "max-w-[480px] mx-auto bg-[#f4f7f6] min-h-screen relative pb-24 shadow-[0_0_20px_rgba(0,0,0,0.05)] text-slate-800 font-sans border-x border-slate-200/60", children: [
    /* @__PURE__ */ jsx(Head, { title: `Cek Stok Paket XL - ${brandName}` }),
    /* @__PURE__ */ jsxs("header", { className: "bg-white sticky top-0 z-50 px-4 py-3 flex items-center justify-between border-b border-slate-100 shadow-[0_2px_10px_-4px_rgba(0,0,0,0.05)]", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2.5", children: [
        /* @__PURE__ */ jsx("div", { className: "w-8 h-8 rounded-full bg-blue-600 flex items-center justify-center text-white text-sm font-bold shadow-sm", children: /* @__PURE__ */ jsx("i", { className: "fa-solid fa-bolt" }) }),
        /* @__PURE__ */ jsx("h1", { className: "font-bold text-[17px] tracking-tight text-slate-800", children: brandName })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "flex items-center gap-2", children: /* @__PURE__ */ jsx("span", { className: "text-[11px] font-semibold text-slate-400", children: time }) })
    ] }),
    /* @__PURE__ */ jsxs("main", { className: "bg-[#f4f7f6] min-h-screen", children: [
      activeTab === "stok" && /* @__PURE__ */ jsxs("div", { className: "p-4 space-y-5 animate-[fadeIn_0.3s_ease-in-out]", children: [
        /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-2xl p-5 shadow-sm border border-slate-100", children: [
          /* @__PURE__ */ jsx("h2", { className: "font-bold text-lg text-slate-800 leading-tight", children: "Cek Stok Paket XL & AXIS" }),
          /* @__PURE__ */ jsx("p", { className: "text-[11px] text-slate-500 mt-1 mb-4", children: "Pantau ketersediaan paket data secara real-time." }),
          /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-end border-t border-slate-100 pt-3", children: [
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("p", { className: "text-[10px] uppercase font-bold text-slate-400 tracking-wider", children: "Total Stok" }),
              /* @__PURE__ */ jsx("p", { className: "text-3xl font-extrabold text-blue-600 mt-0.5", children: new Intl.NumberFormat("id-ID").format(totalStok) })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "text-right", children: [
              /* @__PURE__ */ jsx("p", { className: "text-[10px] uppercase font-bold text-slate-400 tracking-wider", children: "Terakhir diupdate" }),
              /* @__PURE__ */ jsx("p", { className: "text-[11px] font-bold text-slate-700 mt-1 mb-2", children: time }),
              /* @__PURE__ */ jsxs("button", { onClick: () => window.location.reload(), className: "bg-blue-50 text-blue-600 hover:bg-blue-100 px-3 py-1.5 rounded-lg text-[11px] font-bold transition flex items-center gap-1.5 ml-auto", children: [
        ...
        Object.entries(products).map(([categoryName, items]) => /* @__PURE__ */ jsxs("div", { className: "pt-2", children: [
          /* @__PURE__ */ jsx("h2", { className: "text-xl font-extrabold text-slate-800 tracking-tight", children: categoryName }),
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 text-slate-500 text-[11px] font-semibold mb-3 mt-0.5", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 gap-3", children: items.map((p, idx) => {
            const isReady = p.stok > 0;
            const cardId = `prod_${p.product_code}_${idx}`;
            const isOpen = openCards[cardId] || false;
            return /* @__PURE__ */ jsxs("div", { className: `bg-white rounded-[14px] shadow-sm border ${isReady ? "border-green-100" : "border-slate-100"} flex flex-col relative overflow-hidden transition-all duration-200`, children: [
              /* @__PURE__ */ jsxs("div", { className: "p-3 pb-2", children: [
                /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-start mb-2", children: [
                  /* @__PURE__ */ jsx("h3", { className: "font-bold text-[15px] text-slate-800 tracking-tight leading-none", children: p.product_code }),
                  isReady ? /* @__PURE__ */ jsxs("span", { className: "bg-green-100 text-green-600 text-[8px] font-extrabold px-1.5 py-0.5 rounded flex items-center gap-1", children: [
                    /* @__PURE__ */ jsx("span", { className: "w-1.5 h-1.5 rounded-full bg-green-500 animate-pulse" }),
                    " READY"
                  ] }) : /* @__PURE__ */ jsx("span", { className: "bg-slate-100 text-slate-400 text-[8px] font-extrabold px-1.5 py-0.5 rounded", children: "HABIS" })
                ] }),
                /* @__PURE__ */ jsx("div", { className: "text-[9px] text-slate-400 font-bold uppercase tracking-wider mb-0.5", children: "Sisa Slot" }),
                /* @__PURE__ */ jsx("div", { className: `text-2xl font-black ${isReady ? "text-slate-800" : "text-slate-300"} leading-none mb-1`, children: p.stok })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "mt-auto border-t border-slate-100 grid grid-cols-2 text-[10px] font-bold divide-x divide-slate-100", children: [
                /* @__PURE__ */ jsxs("button", { onClick: () => toggleCard(cardId), className: `py-2.5 flex items-center justify-center gap-1 hover:bg-slate-50 transition ${isReady || p.areas.length > 0 ? "text-slate-600" : "text-slate-400"}`, children: [
                  /* @__PURE__ */ jsx("span", { children: isOpen ? "Tutup" : "Detail" }),
                  /* @__PURE__ */ jsx("i", { className: `fa-solid fa-chevron-down text-[8px] transition-transform ${isOpen ? "rotate-180" : ""}` })
                ] }),
                /* @__PURE__ */ jsxs("a", { href: "https://milastore.cloud", target: "_blank", rel: "noreferrer", className: `py-2.5 flex items-center justify-center gap-1 transition ${isReady ? "text-blue-600 hover:bg-blue-50" : "text-slate-400 bg-slate-50 pointer-events-none"}`, children: [
                  "Beli ",
                  /* @__PURE__ */ jsx("i", { className: "fa-solid fa-cart-shopping text-[9px]" })
                ] })
              ] }),
              isOpen && /* @__PURE__ */ jsx("div", { className: "bg-slate-50 border-t border-slate-100 px-3 py-2.5 text-xs animate-[fadeIn_0.2s_ease-in-out]", children: p.areas.length > 0 ? /* @__PURE__ */ jsxs(Fragment, { children: [
                /* @__PURE__ */ jsx("div", { className: "space-y-1", children: p.areas.map((area, i) => /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center py-1 border-b border-slate-200/60 last:border-0", children: [
                  /* @__PURE__ */ jsx("span", { className: "text-slate-500 font-semibold text-[10px]", children: area.name.toUpperCase() }),
                  /* @__PURE__ */ jsx("span", { className: "font-extrabold text-slate-800 text-[11px]", children: area.kuota })
                ] }, i)) }),
                p.note && /* @__PURE__ */ jsxs("div", { className: "mt-2 bg-blue-50/50 border border-blue-100 rounded p-1.5 flex gap-1.5 items-start", children: [
                  /* @__PURE__ */ jsx("i", { className: "fa-solid fa-circle-info text-blue-500 text-[10px] mt-0.5" }),
                  /* @__PURE__ */ jsx("p", { className: "text-[9px] text-blue-700 leading-tight font-medium", children: p.note })
                ] })
              ] }) : /* @__PURE__ */ jsx("div", { className: "text-center text-slate-400 italic text-[10px] py-1", children: "Detail tidak tersedia." }) })
            ] }, cardId);
          }) })
        ] }, categoryName)),
        /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-2xl p-5 text-center shadow-sm border border-slate-100 mt-8 mb-4 space-y-4", children: [
          /* @__PURE__ */ jsx("h3", { className: "font-bold text-slate-800 text-sm", children: "Order Here!!" }),
          /* @__PURE__ */ jsxs("div", { className: "flex justify-center gap-2", children: [
            /* @__PURE__ */ jsxs("a", { href: "https://t.me/LatsCore", target: "_blank", rel: "noreferrer", className: "flex-1 py-2 bg-sky-50 text-sky-600 font-bold text-[11px] rounded-lg border border-sky-100 flex items-center justify-center gap-1.5", children: [
              /* @__PURE__ */ jsx("i", { className: "fa-brands fa-telegram text-sm" }),
              " @LatsCore"
            ] }),
            /* @__PURE__ */ jsxs("a", { href: "https://wa.me/62859106609838", target: "_blank", rel: "noreferrer", className: "flex-1 py-2 bg-green-50 text-green-600 font-bold text-[11px] rounded-lg border border-green-100 flex items-center justify-center gap-1.5", children: [
              /* @__PURE__ */ jsx("i", { className: "fa-brands fa-whatsapp text-sm" }),
              " Admin WA"
            ] })
          ] }),
          /* @__PURE__ */ jsx("div", { className: "pt-3 border-t border-slate-100 text-[11px] text-slate-400", children: /* @__PURE__ */ jsxs("p", { children: [
            "© 2026 ",
            brandName,
            ". All rights reserved."
          ] }) })
      ...
      activeTab === "cek" && /* @__PURE__ */ jsx("div", { className: "p-4 animate-[fadeIn_0.3s_ease-in-out]", children: /* @__PURE__ */ jsxs("div", { className: "bg-white p-6 rounded-2xl shadow-sm text-center border border-slate-100 mt-6", children: [
        /* @__PURE__ */ jsx("div", { className: "w-16 h-16 rounded-full bg-blue-50 text-blue-600 flex items-center justify-center mx-auto mb-3", children: /* @__PURE__ */ jsx("i", { className: "fa-solid fa-sim-card text-2xl" }) }),
        /* @__PURE__ */ jsx("h3", { className: "font-bold text-slate-800 text-lg mb-1", children: "Cek Kuota Kartu" }),
        /* @__PURE__ */ jsx("p", { className: "text-xs text-slate-500 mb-5 leading-relaxed", children: "Gunakan layanan resmi pengecekan kuota provider yang terintegrasi dengan sistem kami." }),
        /* @__PURE__ */ jsxs("a", { href: "https://milastore.cloud/order/cek-kuota", className: "block w-full py-3.5 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-xl text-sm transition shadow-sm shadow-blue-200", children: [
          "Cek Kuota Sekarang ",
          /* @__PURE__ */ jsx("i", { className: "fa-solid fa-arrow-right ml-1" })
        ] })
      ] }) }),
      activeTab === "area" && /* @__PURE__ */ jsx("div", { className: "p-4 space-y-4 animate-[fadeIn_0.3s_ease-in-out]", children: /* @__PURE__ */ jsxs("div", { className: "bg-white p-5 rounded-2xl shadow-sm border border-slate-100", children: [
        /* @__PURE__ */ jsx("h2", { className: "font-bold text-lg text-slate-800 leading-tight", children: "Cari Area Paket XL" }),
        /* @__PURE__ */ jsx("p", { className: "text-[11px] text-slate-500 mt-1 mb-4", children: "Temukan pembagian wilayah Area 1 - 4." }),
        /* @__PURE__ */ jsxs("div", { className: "relative mb-4", children: [
          /* @__PURE__ */ jsx("span", { className: "absolute inset-y-0 left-0 flex items-center pl-3.5 text-slate-400", children: /* @__PURE__ */ jsx("i", { className: "fa-solid fa-magnifying-glass text-[11px]" }) }),
          /* @__PURE__ */ jsx("input", { type: "text", value: searchQuery, onChange: (e) => setSearchQuery(e.target.value), placeholder: "Cari Nama Kota / Kabupaten...", className: "w-full pl-9 pr-3 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-xs font-medium focus:outline-none focus:border-blue-500 focus:bg-white transition" })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-left text-xs", children: [
          /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsxs("tr", { className: "bg-slate-50 text-slate-500 font-bold border-b border-slate-200 uppercase tracking-wide text-[9px]", children: [
            /* @__PURE__ */ jsx("th", { className: "p-3", children: "Provinsi / Wilayah" }),
            /* @__PURE__ */ jsx("th", { className: "p-3 text-center w-14", children: "Area" })
          ] }) }),
          /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-slate-100", children: filteredAreas.length > 0 ? filteredAreas.map((item, idx) => /* @__PURE__ */ jsxs("tr", { children: [
            /* @__PURE__ */ jsxs("td", { className: "p-3", children: [
              /* @__PURE__ */ jsx("span", { className: "block font-bold text-slate-800 mb-0.5", children: item.prov }),
              /* @__PURE__ */ jsx("span", { className: "block text-[10px] text-slate-500 leading-tight", children: item.kota })
            ] }),
            /* @__PURE__ */ jsx("td", { className: "p-3 text-center", children: /* @__PURE__ */ jsx("span", { className: `font-bold px-2 py-1 rounded text-[10px] ${item.area === "1" ? "bg-green-50 text-green-600" : item.area === "2" ? "bg-blue-50 text-blue-600" : "bg-orange-50 text-orange-600"}`, children: item.area }) })
          ] }, idx)) : /* @__PURE__ */ jsx("tr", { children: /* @__PURE__ */ jsx("td", { colSpan: "2", className: "p-4 text-center text-slate-400 italic text-[11px]", children: "Wilayah tidak ditemukan." }) }) })
        ] }) })
      ] }) })
    ] }),
    /* @__PURE__ */ jsxs("nav", { className: "fixed bottom-0 w-full max-w-[480px] bg-white border-t border-slate-100 flex justify-around items-center h-[60px] z-50 shadow-[0_-4px_10px_rgba(0,0,0,0.02)] rounded-t-2xl pb-safe", children: [
      /* @__PURE__ */ jsxs("button", { onClick: () => {
        setActiveTab("stok");
        window.scrollTo(0, 0);
      }, className: `flex flex-col items-center justify-center w-full h-full gap-1 pt-1 transition ${activeTab === "stok" ? "text-blue-600" : "text-slate-400 hover:text-slate-600"}`, children: [
        /* @__PURE__ */ jsx("i", { className: "fa-solid fa-cube text-[16px]" }),
        /* @__PURE__ */ jsx("span", { className: "text-[9px] font-bold", children: "Stok Produk" })
      ] }),
      /* @__PURE__ */ jsxs("button", { onClick: () => {
        setActiveTab("cek");
        window.scrollTo(0, 0);
      }, className: `flex flex-col items-center justify-center w-full h-full gap-1 pt-1 transition ${activeTab === "cek" ? "text-blue-600" : "text-slate-400 hover:text-slate-600"}`, children: [
        /* @__PURE__ */ jsx("i", { className: "fa-solid fa-sim-card text-[16px]" }),
        /* @__PURE__ */ jsx("span", { className: "text-[9px] font-bold", children: "Cek Kuota" })
      ] }),
      /* @__PURE__ */ jsxs("button", { onClick: () => {
        setActiveTab("area");
        window.scrollTo(0, 0);
      }, className: `flex flex-col items-center justify-center w-full h-full gap-1 pt-1 transition ${activeTab === "area" ? "text-blue-600" : "text-slate-400 hover:text-slate-600"}`, children: [
        /* @__PURE__ */ jsx("i", { className: "fa-solid fa-map-location-dot text-[16px]" }),
        /* @__PURE__ */ jsx("span", { className: "text-[9px] font-bold", children: "Data Area" })
      ] })
    ] }),
