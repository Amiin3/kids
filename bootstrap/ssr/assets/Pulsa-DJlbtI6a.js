...
const ProviderIcon = ({ provider }) => {
  if (!provider) return /* @__PURE__ */ jsx("div", { className: "w-11 h-11 rounded-full bg-slate-100 flex items-center justify-center text-slate-400 border border-slate-200 shadow-sm", children: /* @__PURE__ */ jsx("i", { className: "fa-solid fa-mobile-screen text-sm" }) });
  const brands = {
  ...
  return /* @__PURE__ */ jsx("div", { className: `w-11 h-11 rounded-full flex items-center justify-center text-[11px] font-black tracking-tight shadow-md ring-4 ${b.bg} ${b.ring} shrink-0`, children: b.label });
};
function Pulsa({ auth, groupedProducts, userBalance }) {
  ...
  return /* @__PURE__ */ jsxs(AuthenticatedLayout, { user: auth.user, children: [
    /* @__PURE__ */ jsx(Head, { title: "Isi Pulsa" }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-slate-50 font-['Outfit'] pb-32", children: [
      /* @__PURE__ */ jsxs("div", { className: "bg-gradient-to-br from-indigo-700 via-purple-700 to-fuchsia-700 px-5 pt-8 pb-20 rounded-b-[40px] shadow-lg shadow-purple-900/20 relative overflow-hidden", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center relative z-10", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "text-center", children: [
            /* @__PURE__ */ jsx("h1", { className: "text-xl font-black text-white tracking-widest uppercase drop-shadow-md", children: "Isi Pulsa" }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "max-w-md mx-auto px-4 -mt-10 relative z-20", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "flex flex-col gap-3", children: phone.length < 4 ? /* @__PURE__ */ jsxs("div", { className: "text-center py-12 bg-white border border-dashed border-slate-200 rounded-[24px] mt-2 shadow-sm", children: [
          /* @__PURE__ */ jsx("div", { className: "w-16 h-16 bg-slate-50 rounded-full flex items-center justify-center mx-auto mb-3 text-slate-300 text-2xl", children: /* @__PURE__ */ jsx("i", { className: "fa-solid fa-mobile-button" }) }),
          ...
          /* @__PURE__ */ jsx("p", { className: "text-[11px] text-slate-400 font-bold uppercase tracking-widest", children: "Pulsa Kosong" })
