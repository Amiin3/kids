...
class OrderPlnController extends Controller
{
    ...
    public function store(Request $request) {
        ...
        $jenis = strip_tags($request->input('jenis', 'prabayar'));
        ...
        try {
            ...
            if ($jenis === 'prabayar' && (float)$user->saldo < (float)$realPrice) {
                DB::rollBack();
            ...
            DB::rollBack();
            Log::error('[PLN ORDER DB ERROR] ' . $e->getMessage());
