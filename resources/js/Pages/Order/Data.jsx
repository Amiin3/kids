...
const ProviderIcon = ({ provider }) => {
    ...
    const b = brands[provider] || { bg: 'bg-gradient-to-br from-indigo-500 to-purple-600', text: provider.substring(0,3), icon: 'fa-bolt' };

    return (
        <div className={`w-10 h-10 rounded-full flex flex-col items-center justify-center text-white shadow-md border border-white/20 ${b.bg} shrink-0`}>
            <span className="text-[10px] font-black uppercase tracking-wider mt-0.5">{b.text}</span>
        </div>
    );
};
...
export default function Data({ auth, groupedProducts, userBalance }) {
    ...
    // 📡 RADAR PROVIDER SUPER AKURAT (Semua Nomor Indonesia)
    useEffect(() => {
        if (phone.length >= 4) {
            ...
            setProvider(null); setSelected(null);
        }
    }, [phone]);
                ...
                <div className="bg-gradient-to-br from-indigo-700 via-purple-700 to-fuchsia-700 px-5 pt-8 pb-20 rounded-b-[40px] shadow-lg shadow-purple-900/20 relative overflow-hidden">
                    ...
                    <div className="flex justify-between items-center relative z-10">
                        ...
                        <div className="text-center">
                            <h1 className="text-xl font-black text-white tracking-widest uppercase drop-shadow-md">Paket Data</h1>
                ...
                <div className="max-w-md mx-auto px-4 -mt-10 relative z-20">
                    ...
                    <div className="bg-white p-4 rounded-[24px] shadow-xl shadow-slate-200/50 border border-slate-100 mb-6 animate-in slide-in-from-bottom-2">
                        <div className="flex justify-between items-center mb-2 px-2">
                            ...
                            {provider && <span className="text-[9px] font-black uppercase text-indigo-500 bg-indigo-50 px-2 py-0.5 rounded-md animate-in fade-in">{provider}</span>}
                        </div>
                    ...
                    <div className="bg-slate-200/50 p-1.5 rounded-[16px] flex mb-6">
                        ...
                        >
                            <i className="fa-solid fa-bolt mr-1"></i> Reguler
                        </button>
                        <button 
                        ...
                        >
                            <i className="fa-solid fa-fire mr-1"></i> Promo
                        </button>
                    </div>
                    ...
                    <div className="flex flex-col gap-3">
                        {phone.length < 4 ? (
                            <div className="text-center py-12 bg-white border border-dashed border-slate-200 rounded-[24px] mt-2 shadow-sm">
                                ...
                                <p className="text-[11px] text-slate-400 font-bold uppercase tracking-widest">Ketik Nomor<br/>Memunculkan Paket</p>
                            </div>
                            ...
                            <div className="text-center py-12 bg-white rounded-[24px] border border-slate-100 shadow-sm animate-in zoom-in">
                                ...
                                <p className="text-[11px] text-slate-400 font-bold uppercase tracking-widest">Paket Kosong</p>
                            </div>
                        ) : (
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <div className="text-right flex flex-col justify-center items-end min-w-[85px] pl-2 border-l border-slate-100">
                                            <span className="text-[10px] text-slate-400 line-through font-bold">Rp {formatRp(hargaCoret)}</span>
