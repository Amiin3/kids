...
export default function Token({ auth, productsPrabayar, productsPascabayar, userBalance }) {
    const { flash } = usePage().props;
    const [tab, setTab] = useState('prabayar'); // prabayar / pascabayar
    ...
    // Filter produk berdasarkan server yang dipilih (Digiflazz / Okeconnect)
    ...
    const handleOrder = () => {
        ...
        Swal.fire({
            title: `<div class="text-xl font-black text-slate-800 mt-2">Konfirmasi Token PLN</div>`,
            html: `
                <div class="text-left mt-3 space-y-3">
                    <div class="bg-slate-50 p-4 flex justify-between items-center rounded-[16px] border border-slate-100 shadow-sm">
                        <span class="text-xs font-bold text-slate-400 uppercase tracking-wider">No. Meter / Pelanggan</span>
        ...
        <AuthenticatedLayout user={auth.user}>
            ...
            <div className="min-h-screen bg-slate-50 font-['Outfit'] pb-32">
                ...
                <div className="max-w-md mx-auto px-4 -mt-10 relative z-20">
                    ...
                    {/* 🎛️ SEGMENTED CONTROL SERVER (DIGIFLAZZ & OKECONNECT) */}
